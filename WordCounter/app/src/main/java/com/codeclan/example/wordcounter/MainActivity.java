...
//        textView = (TextView)findViewById(R.id.text_result);
    ...
    public void onWordCountButtonClick(View view) {
        ...
        Integer numberOfWords = WordCounter.getCount(textToScan);
        Log.d("number of words: ", numberOfWords.toString());

        Intent intent = new Intent(this, CountActivity.class);

        // add the answer in key value pair to the Bundle:
        intent.putExtra("answer", numberOfWords.toString());
